...
class KNearestNeighbor:
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in range(num_test):
            ...
            #closest_y = dists[i].argsort()[:k].tolist()
            #targets = self.y_train[closest_y]
            targets, count = np.unique(self.y_train[closest_y], return_counts=True)
            #count = Counter(targets)
            #[[x,targets.count(x)] for x in set(targets)]
            # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
            #########################################################################
            # TODO:                                                                 #
            ...
            #########################################################################
            # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
            y_pred[i] = targets[np.argmax(count)]
